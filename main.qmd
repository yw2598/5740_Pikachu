...
rf_model <- randomForest(quality ~ ., data = training_data, ntree = 3, mtry = 5, importance = TRUE)

# Predict on the testing data
predictions <- predict(rf_model, testing_data)

# Calculate the accuracy
accuracy_rf <- sum(predictions == testing_data$quality) / nrow(testing_data)
print(paste("Accuracy of the Random Forest model:", accuracy))
